...
from data.imagenet_subsets import create_imagenet_subset, class_mapping_164_to_109
from data.corruptions_datasets import create_cifarc_dataset, create_imagenetc_dataset
from data.imagenet_d_utils import create_symlinks_and_get_imagenet_visda_mapping
from data.imagenet_dict import map_dict
from data.augmentations.transforms_adacontrast import get_augmentation_versions, get_augmentation,get_augmentation_versions_image
try:
...
def get_transform(dataset_name, adaptation):
    ...
    if adaptation == "adacontrast":
        ...
        if dataset_name in {"cifar10", "cifar100", "cifar10_c", "cifar100_c"}:
            ...
            transform = get_augmentation_versions(aug_versions="tcss", aug_type="moco-v2", res_size=256, crop_size=224)
        else:
